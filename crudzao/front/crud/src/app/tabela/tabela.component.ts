...
export class TabelaComponent implements OnInit {
  ...
  colunas:camposRegistro[]=[
    {field:'cod', value:'codigo123', enabled:true},
    {field:'loja', value:'02', enabled:true},
    {field:'nome', value:'Lucia Carvalho Oliveira Macieira', enabled:true},
    {field:'nreduz', value:'nreduz', enabled:false},
    {field:'tipo', value:'X', enabled:false},
    {field:'est', value:'MG', enabled:true},
